...
public class Reset extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setMinimumSize(new java.awt.Dimension(554, 737));
        ...
        resetBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/reset_button.png"))); // NOI18N
        ...
        resetBtn.setBounds(150, 460, 210, 80);
        ...
        verifyLabel.setText("Verify New Password");
        ...
        verifyLabel.setBounds(30, 280, 180, 30);
...
// TODO add your handling code here:
    ...
    private void resetBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resetBtnMouseClicked
       ...
       /* try {
        String usernameCheck = "SELECT Password FROM Login where Name = ?";
           ...
           JOptionPane.showMessageDialog(null, "Your password is " + res, "Lumen", JOptionPane.INFORMATION_MESSAGE);  
         ...
         try {
        String resetPass = "UPDATE Login SET Password = ? where Username = ? AND [E-Mail] = ?";
            pst = login.prepareStatement(resetPass);
            ...
            pst.executeUpdate();
             ...
             String user = usernameField.getText();
                JOptionPane.showMessageDialog(null, user + ", " + "your password has been reset. ", "Lumen", JOptionPane.INFORMATION_MESSAGE);  
                setVisible(false);
                new Login().setVisible(true);
            ...
            JOptionPane.showMessageDialog(null, "Data not found!", "Lumen", JOptionPane.ERROR_MESSAGE); 
        }   
